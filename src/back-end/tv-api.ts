...
import type { TvPopularResponse, TvShowDetails } from './api-schemas'
 ...
 *
 * Both endpoints require a valid TMDB API token to be set in the environment variable (TMDB_API_TOKEN).
