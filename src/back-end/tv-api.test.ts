...
describe('registerTvApi', () => {
    ...
    it('registers popular and tv-details endpoints', () => {
    ...
    describe('GET /api/tv/:id', () => {
        it('returns early when API key is missing', async () => {
            ...
            await handler?.({ query: {}, params: { id: '42' } }, res)
        ...
        it('builds details URL, fetches, and returns JSON on success', async () => {
            ...
            const handler = routes.get('/api/tv/:id')
            const req = { params: { id: '1399/abc' }, query: { language: 'x' } }
            const res = createMockResponse()
        ...
        it('returns 500 when details fetch throws', async () => {
            ...
            await handler?.({ params: { id: '1399' }, query: {} }, res)
